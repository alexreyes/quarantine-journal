...
<input aria-label={ariaLabel} class='form-control' {placeholder} bind:this={search} type="text" {disabled} bind:value={viewValue} on:blur={blur} on:keydown={autocompleteKeydown} required/>
...
<script>
  ...
  export let placeholder = 'City, Country'
